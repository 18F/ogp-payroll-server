...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(name='County',
                               fields=[
        ...
        migrations.CreateModel(name='State',
                               fields=[
                                   ('id', models.AutoField(auto_created=True,
                                                           primary_key=True,
                                                           serialize=False,
        ...
        migrations.CreateModel(name='WageDetermination',
                               fields=[
                                   ('id', models.AutoField(auto_created=True,
                                                           primary_key=True,
                                                           serialize=False,
        ...
        migrations.AddField(model_name='rate',
                            ...
                            field=models.ForeignKey(
                                ...
                                to='wage_determinations.WageDetermination'), ),
        migrations.AddField(model_name='county',
                            name='us_state',
                            field=models.ForeignKey(
                                on_delete=django.db.models.deletion.CASCADE,
